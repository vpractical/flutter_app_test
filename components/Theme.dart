...
///创建应用全局主题时，提供一个ThemeData给MaterialApp就可以了，如果没有提供，Flutter会提供一个默认主题
///局部主题在应用程序中用于覆盖全局主题
///1 直接创建特有的ThemeData
///2 是扩展父主题,扩展父主题时无需覆盖所有的主题属性，我们可以通过使用copyWith方法来实现
///3 再Widget的build方法中通过Theme.of(context)函数来使用它。Theme.of(context)将查找Widget树并返回树中最近的Theme
void main() {
  runApp(MaterialApp(
    theme: _themeData,
    home: Scaffold(
...
class Body extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    var theme = _themeData.copyWith();
    return Column(
      children: <Widget>[
        Theme(data: ThemeData(), child: Text('11111111')),
        Theme(data: theme, child: Text('11111111')),
        Theme(data: Theme.of(context), child: Text('11111111')),
      ],
    );
  }
}
